          ...
          <div className="lg:col-span-8 text-left space-y-8 bg-slate-50 border border-slate-100 p-8 md:p-12 rounded-4xl">
            {activeTab === "privacy" && (
              ...
              >
                ...
                <p>
                  At The Learner Centered Consult (LCC), we are committed to safeguarding the privacy and sensitive medical records of the children and families we serve. This policy outlines how we capture, encrypt, and handle personal and diagnostic data.
                </p>
            ...
            {activeTab === "terms" && (
              ...
              >
                ...
                <p>
                  By accessing the services, consulting tools, or scheduling portals offered by The Learner Centered Consult (LCC) on this web application, you agree to comply with the following operational terms.
                </p>
                ...
                <p>
                  We request that parents and schools provide at least 24 hours of notice before cancelling or rescheduling clinical assessment blocks or therapy sessions.
                </p>
            ...
            {activeTab === "accessibility" && (
              ...
              >
                ...
                <p>
                  The Learner Centered Consult (LCC) is dedicated to ensuring digital accessibility for neurodivergent individuals, parents with physical limitations, and clinical practitioners. We are continually improving our user interface to align with WCAG 2.1 AA standards.
                </p>

                <h3 className="font-display text-lg font-bold text-surface-dark">1. Standard Conformance</h3>
                <p>
                  This web application utilizes semantic HTML markers, keyboard focus outlines, high-contrast text ratios, and custom ARIA labels on all dynamic buttons and form sub-selectors to facilitate screen-reader navigation.
                </p>
