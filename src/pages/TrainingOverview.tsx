...
export default function TrainingOverview() {
  const trainings = [
    ...
    },
    {
      ...
      desc: "Focused skill-building sessions on specialized topics like AAC, sensory diets, and transition planning.",
    ...
    },
    {
      ...
      desc: "Accredited ongoing education for clinical excellence including grand rounds, journal clubs, and conferences.",
    ...
    <div className="bg-white">
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {trainings.map((t, idx) => {
            const data = trainingPrograms[t.id];
            return (
              <motion.div
                key={t.id}
